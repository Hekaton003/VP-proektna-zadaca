...
namespace MilionaireQuiz
{
    public class Game
    {
        ...
        public static void loadQuestions()
        {
            ...
            SportQuestions.Add(new Question(
                "tWhat country has competed the most times in the Summer Olympics yet hasn’t won a gold medal?",
                "Philippines",
            ...
            MusicQuestions.Add(new Question(
                "What is Michael Jackson's biggest hit?",
                "Billie Jean",
            ...
            GeographyQuestions.Add(new Question(
            "What is the name of the third longest river in Africa?",
            "Niger river",
            ...
            TechnologyQuestions.Add(new Question(
            "What country has the largest market of gamers?",
            "China",
